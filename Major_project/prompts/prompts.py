class templates:
    ...
    front_end_template = """
            I want you to act as an interviewer for a Front End role. Remember, you are the interviewer, not the candidate. 
            
            Let's think step by step.
            
            Based on the Resume, 
            Create a guideline with the following topics for an interview to test the knowledge of the candidate on necessary skills for being a Front End Developer.
    ...
    # Back End role
    back_end_template = """
            I want you to act as an interviewer for a Back End role. Remember, you are the interviewer, not the candidate. 
            
            Let's think step by step.
            
            Based on the Resume, 
            Create a guideline with the following topics for an interview to test the knowledge of the candidate on necessary skills for being a Back End Developer.
    ...
    # Full Stack role
    full_stack_template = """
            I want you to act as an interviewer for a Full Stack role. Remember, you are the interviewer, not the candidate. 
            
            Let's think step by step.
            
            Based on the Resume, 
            Create a guideline with the following topics for an interview to test the knowledge of the candidate on necessary skills for being a Full Stack Developer.
    ...
    # QA role
    qa_template = """
            I want you to act as an interviewer for a QA (Quality Assurance/Testing) role. Remember, you are the interviewer, not the candidate. 
            
            Let's think step by step.
            
            Based on the Resume, 
            Create a guideline with the following topics for an interview to test the knowledge of the candidate on necessary skills for being a QA Engineer.
    ...
    # SWE Intern role
    swe_intern_template = """
            I want you to act as an interviewer for a Software Engineering Intern role. Remember, you are the interviewer, not the candidate. 
            
            Let's think step by step.
            
            Based on the Resume, 
            Create a guideline with the following topics for an interview to test the knowledge of the candidate on necessary skills for being a Software Engineering Intern.
